...
const logChannel = "519836133803294731"; // logs channel id
...
client.on('message', message => {
	...
	client.on("ready", () => {
  function lol() {
    client.guilds.get('516971367003062273').roles.find("Rainbow", "Rainbow").setColor("RANDOM");
  };
...
message.channel.send('**تم انشاء الرتب بنجاح**') 
.catch(console.error);
    }
});
client.on('message', message => {
